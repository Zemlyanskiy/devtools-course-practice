...
TEST(LineSegment, Set_Initial_Value_Works_Correctly) {
  ...
  line.Set_B(10.3);
  line.Set_C(-3.5);
  EXPECT_TRUE((1.1 == line.Get_Coeff(1)) &&
             (10.3 == line.Get_Coeff(2)) &&
             (-3.5 == line.Get_Coeff(3)));
}
